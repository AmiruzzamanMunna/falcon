			...
			<div class="row">
				<div class="col-md-6 col-sm-4 m-auto">
					<div class="col-md-8 col-sm-6 section-item-name m-auto">
						<a class="m-auto" href="{{route('user.weddingEventPage')}}">{{$event->heading2}}</a>
					</div>
				...
				<div class="col-md-4 col-sm-4 m-auto">
					<div class="col-md-7 col-sm-6 section-item-name m-auto">
						<a class="m-auto" href="{{route('user.birthdayEventPage')}}">{{$event->heading3}}</a>
					</div>
					<div class="itemcontain">
				...
				<div class="col-md-6 col-sm-4 m-auto">
					<div class="col-md-11 col-sm-6 section-item-name m-auto">
						<a class="m-auto" href="{{route('user.HospitalityEventPage')}}">{{$event->heading4}}</a>
					</div>
					<div class="itemcontain">
				...
				<div class="col-md-4 col-sm-4 m-auto">
					<div class="col-md-6 col-sm-6 section-item-name m-auto">
						<a class="m-auto" href="{{route('user.othersEventPage')}}">{{$event->heading5}}</a>
					</div>
					<div class="itemcontain">
