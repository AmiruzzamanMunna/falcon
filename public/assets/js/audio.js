...
(function($) {
	...
	function cP() {
		...
		h.c.pF = h.d("i", {
			a : "class",
			v : "icofont-play-alt-1"
		},undefined,undefined);

		
		h.c.rF = h.d("i", {
			a : "class",
			v : "icofont-caret-left"
		},undefined,undefined);
		
		h.c.fF = h.d("i", {
			a : "class",
			v : "icofont-caret-right"
		},undefined,undefined);
	...
	function uT() {
		h.upt = setInterval(function() {
			...
			if(h.c.vr.value == 0){
				h.c.vF.setAttribute("class","icofont-volume-off");
			}else if(h.c.vr.value <= 50){
				h.c.vF.setAttribute("class","icofont-volume-down");
			}else if(h.c.vr.value >= 50){
				h.c.vF.setAttribute("class","icofont-volume-up");
			}
			}
		}, 100);
	}
	...
	var pL = function() {
			if(h.c.a.duration > 0){
			if(this.children[0].getAttribute("class") == "icofont-play-alt-1"){
				h.c.a.play();
				this.setAttribute("class", "pause");
				this.children[0].setAttribute("class", "icofont-ui-play-stop");
				uT();
			}else if(this.children[0].getAttribute("class") == "icofont-ui-play-stop"){
				h.c.a.pause();
				this.setAttribute("class", "play");
				this.children[0].setAttribute("class", "icofont-play-alt-1");
				clearInterval(h.upt);
			}
			}
	}
	...
	function rpa() {
			h.c.ply.children[0].setAttribute("class", "icofont-play-alt-1");
