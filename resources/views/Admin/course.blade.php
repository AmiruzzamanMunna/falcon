      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="catname" id="authorname" class="form-control">   
                <p id="pauthname" style="color: red">This field is required</p>             
            </div>
            <div class="form-group">
                <label for="">Credit Hour</label>
                <input type="text" name="catname" id="credithour" class="form-control">   
                <p id="pcredit" style="color: red">This field is required</p>             
            </div>
            <div class="form-group">
                <label for="">Course Description</label><br><br>
                <textarea name="" id="coursedescription" cols="48" rows="10"></textarea>  
            ...
            <div class="form-group">
                ...
                <textarea name="" id="courserequire" cols="48" rows="10"></textarea>  
                <p id="preq" style="color: red">This field is required</p>             
            </div>
            <div class="form-group">
                <label for="">Course price</label>
                <input type="text" name="catname" id="courseprice" class="form-control">   
